...
<html lang="en">
    ...
    <body class="bg-primary">
        <div id="app">
            <div class="container justify-content-center align-items-center col-6 mt-5">
                <h1>Todo List</h1>
                <hr class="text-white border border-2">
                <ul class="list-group border border-1 rounded">
                    <li v-for="(todo, i) in todoList" :key="i" :class="{'text-decoration-line-through' : todo['done']}" class="list-group-item"> {{ todo['text'] }} </li>
                </ul>
